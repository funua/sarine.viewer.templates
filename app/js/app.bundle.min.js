...
},i.next=function(){this.goTo(this.currentItemIndex>=this.allItemsArrayLength&&this.options.carousel===!0?0:this.currentItemIndex+1)},i.bindEvents=function(){if(h.push(this.$selector),this.buttonPrevious||this.buttonNext){var a=this;this.buttonPrevious.addEventListener("click",function(b){b.preventDefault(),a.previous()}),this.buttonNext.addEventListener("click",function(b){b.preventDefault(),a.next()})}},i.on=function(a,b){if("change"!==a)throw new Error('the only available event is "change"');this.$selector.addEventListener(a,function(a){return b(a)},!1)},i.createCustomEvent=function(){var a=this;this.event=new g("change",{detail:{parentSelector:a.$selector,currentItemIndex:Number(a.currentItemIndex)},bubbles:!0,cancelable:!0})},g.prototype=window.Event.prototype,window.CustomEvent=g,"function"==typeof define&&define.amd?define(function(){return b}):"undefined"!=typeof module&&module.exports?module.exports=b:a.WallopSlider=b}(this),function(a,b){"use strict";function c(a){a=a||{},this._overlay=a.overlay,this._openClassName=a.openClassName||"popup-wrap--open",this._closeClassName=a.closeClassName||"popup-wrap--close",this._openOverlayClassName=a.openOverlayClassName||"popup-overlay--open"}c.prototype.open=function(a){var c=this.currentElement;c!==a&&(c&&this.close(c),this.currentElement=a,b.add(this._overlay,this._openOverlayClassName),b.remove(a,this._closeClassName),b.add(a,this._openClassName))},c.prototype.close=function(a){var c;this.currentElement=null,b.remove(this._overlay,this._openOverlayClassName),b.remove(a,this._openClassName),b.add(a,this._closeClassName),c=a.querySelector("video"),c&&(c.pause(),c.currentTime=0)},a.PopupService=c}(window,window.classie),function(a,b){"use strict";function c(a){a=a||{};var c=Array.prototype.slice.call(a.bulletsContainer.querySelectorAll(a.bulletClassName),0),d=0,e=a.slider,f=a.activeBulletClassName||"",g=a.startFrom||0;c.forEach(function(a,b){a.addEventListener("click",function(){e.goTo(b+g)})}),f&&e.on("change",function(a){b.remove(c[d],f),d=a.detail.currentItemIndex,b.add(c[d],f)})}a.BulletNavigation=c}(window,window.classie),function(a,b){"use strict";function c(a){function c(){a.style.display=""}function d(){a.style.display="none"}function e(){g.play(),d()}var f=a.getAttribute("data-video-id"),g=b.getElementById(f||""),h=!1;g&&(g.addEventListener("ended",c),g.addEventListener("pause",c),g.addEventListener("canplay",function(){h&&(h=!1,e())}),g.addEventListener("play",function(){d()}),a.addEventListener("click",function(){g.readyState<3?(g.src=g.getAttribute("data-src"),g.load(),h=!0):e()}))}var d={initButton:c};a.videoPlay=d}(window,window.document),function(a,b,c,d,e,f,g,h,i,j){c(function(){"use strict";function k(a,b){return 0===b.length?a:a?k(a[b.shift()],b):void 0}function l(){var c,d=s&&s.lightGrades&&s.lightGrades.totalGrade&&s.lightGrades.totalGrade.name,e=a.gradeScales||{},f=e.totalGrade,g=b.querySelector("[data-total-grade]"),h=b.querySelector("[data-total-grade-stars]");d&&f&&f.some(function(a){return a.name===d?(c=a["default-display"],g.innerHTML=c.split(" ")[0],h.innerHTML=new Array(parseInt(c[c.length-1])+1).join("★"),!0):!1})}var m=new g(b.querySelector(".slider"),{btnPreviousClass:"slider__btn--previous",btnNextClass:"slider__btn--next",itemClass:"slide",currentItemClass:"slide--current",showPreviousClass:"slide--show-previous",showNextClass:"slide--show-next",hidePreviousClass:"slide--hide-previous",hideNextClass:"slide--hide-next"}),n=(new i({slider:m,bulletsContainer:b.querySelector(".storyline"),bulletClassName:".storyline__item",activeBulletClassName:"storyline__item--active"}),new i({slider:m,bulletsContainer:b.querySelector(".summary__story-wrap"),bulletClassName:".summary__story",startFrom:1}),new h({overlay:b.getElementById("popup_overlay")})),o=Array.prototype.slice.call(b.querySelectorAll("[data-popup-id]"),0),p=Array.prototype.slice.call(b.querySelectorAll(".popup__close-btn"),0),q=Array.prototype.slice.call(b.querySelectorAll("[data-sarine-info]"),0),r=Array.prototype.slice.call(b.querySelectorAll("[data-light-grade]"),0),s=a.stones&&a.stones[0],t={1:"minimum",2:"standard",3:"high",4:"very-high",5:"exceptional"},u=1,v=Array.prototype.slice.call(b.querySelectorAll("[data-video-id]"),0),w=Array.prototype.slice.call(b.querySelectorAll("canvas"),0),x=new f(b.getElementById("slider"));d.attach(b.body),m.on("change",function(a){var b=a.detail.parentSelector.querySelector(".slider__header");0===a.detail.currentItemIndex?(e.add(b,"slider__header--hide"),e.remove(b,"slider__header--show"),e.add(a.detail.parentSelector,"slider--summary")):(e.remove(b,"slider__header--hide"),e.add(b,"slider__header--show"),e.remove(a.detail.parentSelector,"slider--summary")),2===a.detail.currentItemIndex?e.add(a.detail.parentSelector,"slider--loupe"):e.remove(a.detail.parentSelector,"slider--loupe")}),w.forEach(function(a){e.has(a,"no_stone")&&u--}),u>0?c(b).on("full_init_end",function(a,c){console.log(c),u--,0>=u&&(b.querySelector(".slider").style.display="",b.querySelector(".preloader").style.display="none")}):(b.querySelector(".slider").style.display="",b.querySelector(".preloader").style.display="none"),x.on("swipeleft swiperight",function(a){"swipeleft"===a.type?m.next():m.previous()}),q.forEach(function(a){var b=a.getAttribute("data-sarine-info"),c=k(s,b.split("."));void 0===c||null===c?a.parentNode.style.display="none":"stoneProperties.carat"===b&&(a.innerHTML=parseFloat(c).toFixed(3))}),l(),r.forEach(function(a){var b=s&&s.lightGrades&&s.lightGrades[a.getAttribute("data-light-grade")],c=b&&b.value;c&&t[c]&&e.add(a,"specs__points--"+t[c])}),o.forEach(function(a){var c=b.getElementById(a.getAttribute("data-popup-id"));c&&a.addEventListener("click",function(){n.open(c)})}),p.forEach(function(a){a.addEventListener("click",function(){n.close(a.parentNode.parentNode)})}),v.forEach(function(a){j.initButton(a)})})}(window,window.document,window.jQuery,window.FastClick,window.classie,window.Hammer,window.WallopSlider,window.PopupService,window.BulletNavigation,window.videoPlay);